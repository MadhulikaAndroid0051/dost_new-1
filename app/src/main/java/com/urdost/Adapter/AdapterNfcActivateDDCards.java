...
public class AdapterNfcActivateDDCards extends RecyclerView.Adapter<AdapterNfcActivateDDCards.ViewHolder> {

    private List<LstnfcDdCard> models;
    private Context context;
    private ActivateNfcDDCardlistner nfcDDCardlistner;

    public AdapterNfcActivateDDCards(List<LstnfcDdCard> models, Context context, ActivateNfcDDCardlistner nfcDDCardlistner) {
        this.models = models;
