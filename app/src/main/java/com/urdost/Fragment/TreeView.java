    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.movetoroot:
                loginId = PreferencesManager.getInstance(context).getPk_userId() + "";
                getTreeViewDetail(loginId);
                break;
            case R.id.node_one:
...
//                ((MainContainerActivity) context).gotoFragment(null, new SignupFragment());
            }
        } else {
...
//        tv_activate_with.setText(tree_view_arr.get(i).getString("PackageAmount"));
                ...
                totalmembers_left.setText(String.valueOf(Integer.parseInt(tree_view_arr.get(i).getActiveLeft()) + Integer.parseInt(tree_view_arr.get(i).getInactiveLeft())));
                ...
                totalmembers_total.setText(String.valueOf(Integer.parseInt(totalmembers_left.getText().toString()) + Integer.parseInt(totalmembers_right.getText().toString())));
                totalbuis_total.setText(String.valueOf((Double.parseDouble(tree_view_arr.get(i).getBusinessLeft()) + Double.parseDouble(tree_view_arr.get(i).getBusinessRight()))));
                break;
            }
        }
    ...
    private void getTreeViewDetail(String loginId) {
        ...
        object.addProperty("Fk_headId", PreferencesManager.getInstance(context).getPk_userId());
