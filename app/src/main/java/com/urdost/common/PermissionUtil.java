...
public class PermissionUtil {
    ...
    public static void showPermissionDialog(Context mContext, String msg) {
        AlertDialog.Builder builder = new AlertDialog.Builder(mContext, R.style.DatePickerDialogTheme);
        builder.setTitle("Need Permission");
        builder.setMessage(msg);
        builder.setPositiveButton(mContext.getString(R.string.permission_camera_rationale11), (dialogInterface, i) -> {
        ...
        builder.setNegativeButton(mContext.getString(R.string.permission_camera_rationale11), (dialogInterface, i) -> {
            dialogInterface.dismiss();
        });
        builder.show();
