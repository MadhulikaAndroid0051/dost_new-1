...
//    logging.setLogLevel(LogLevel.FULL).setLog(new AndroidLog("YOUR_LOG_TAG"));
    ...
    public static <S> S createMarketFile(Class<S> serviceClass) {
    ...
    public static <S> S createNewsFile(Class<S> serviceClass) {
        Retrofit retrofit = new Retrofit.Builder()
    ...
    private static <S> S createServiceUtilityV2(
        ...
        if (!TextUtils.isEmpty(authToken)) {
            ...
            if (!httpClient.interceptors().contains(interceptor)) {
                ...
                loggingInterceptor.setLevel(HttpLoggingInterceptor.Level.BODY);// set your desired log level
...
//    }
    ...
    private static OkHttpClient provideOkHttpClient() {
        ...
        return new OkHttpClient.Builder().readTimeout(1, TimeUnit.MINUTES).connectTimeout(2, TimeUnit.MINUTES).addInterceptor(loggingInterceptor).build();
        }
        else
        {
